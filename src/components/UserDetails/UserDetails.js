...
class UserDetails extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    firebase
      .database()
      .ref('users/' + nextProps.match.params.userId)
      .once('value', snap => {
        this.setState({
          ...this.state,
          loading: false,
        ...
        .once('value', snap => {
          ...
          if (key !== undefined || key !== null) {
            ...
            if (thread !== undefined) {
              ...
              if (index > -1) answeredQuestions.splice(index, 1)
          ...
          <div className="UserDetails">
            ...
            {this.state.user === null ? (
              <p className="UserDetails-unknown">
                <span className="tag error upper">ERROR: </span>
              ...
              <div className="row auto">
                <div className="col UserDetails-user">
                  <fieldset>
                    ...
                    <p>
                      <span className="tag success upper">Likes </span> <span>{likes}</span>
                    </p>
                    <p>
                      <span className="tag focus upper">Name </span>{' '}
                      <span>{this.state.user.displayName}</span>
                    </p>
                    <p>
                      <span className="tag warning upper">Joined </span>{' '}
                      <span>{moment(this.state.user.registeredAt).format('LL')}</span>
                    </p>
                    <p>
                      <span className="tag error upper">Email </span>{' '}
